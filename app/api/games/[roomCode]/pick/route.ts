...
import { activeParticipantId, rotatePickOrder } from "@/lib/draft";
...
// last one needed this round, batch-reveal the round and advance to the
// next one.
export async function POST(
  ...
  // Last pick of the round: reveal every card in this round at once, then
  ...
  return NextResponse.json({ ok: true, roundComplete: true, gameComplete });
}
