  ...
  return (
    <div className="flex w-full flex-col items-center gap-1.5">
      ...
      <div className="flex h-4 w-full items-center justify-center">
        {claimedByTeamName && (
          <p className="truncate font-body text-[11px] font-semibold uppercase tracking-wide text-gold-light">
            {claimedByTeamName}
          </p>
        )}
      </div>
        ...
        >
          {player && (
            <div className="relative flex h-full w-full flex-col p-2">
              ...
              {player.is_overseas && (
                <div className="absolute right-1.5 top-1.5 h-4 w-4 overflow-hidden rounded-sm opacity-90">
                  <Image
