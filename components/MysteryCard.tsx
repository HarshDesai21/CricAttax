      ...
      >
        ...
        >
          ...
          {/* Private hint overlay -- only ever rendered from data that came
              ...
              noticeably at lg: -- per feedback (twice now) that this
              overlay especially needs to stay readable once someone's
              actually paid for it. */}
          {state === "hidden" && privateHint && (
            <div className="absolute inset-x-1 bottom-1 rounded bg-black/70 px-2 py-1.5 text-center ring-1 ring-gold/50 lg:inset-x-2 lg:bottom-2 lg:rounded-md lg:px-3 lg:py-2.5">
              <div className="flex items-center justify-center gap-1 lg:gap-2">
                <div className="h-3 w-4 flex-shrink-0 overflow-hidden rounded-[2px] lg:h-5 lg:w-7">
                  <Image
                ...
                <span className="font-body text-[10px] font-semibold tracking-wide text-gold-light lg:text-sm">
              ...
              {(privateHint.battingAvg != null || privateHint.bowlingAvg != null) && (
                <p className="font-body text-[10px] text-silver/70 lg:text-sm">
              ...
              {privateHint.name && (
                <p className="truncate font-display text-xs font-semibold text-gold-light lg:text-base">
                  {privateHint.name}
                </p>
              )}
            </div>
