...
export function HintPanel({
  ...
  return (
    <div className="w-full max-w-2xl rounded-lg border border-gold/25 bg-black/20 p-3 text-center lg:max-w-none lg:p-5">
      <p className="mb-2 font-body text-xs uppercase tracking-wide text-silver/50 lg:mb-3 lg:text-sm">
        {hintUsedThisRound
      ...
      {!hintUsedThisRound && (
        ...
        // and cramped on a laptop screen.
        <div className="flex flex-wrap justify-center gap-2 lg:flex-col lg:items-stretch lg:gap-3">
          {TIERS.map(({ tier, cost, label }) => (
            <Button
              ...
              className="!px-3 !py-1.5 !text-xs lg:!px-5 lg:!py-3 lg:!text-base"
            >
